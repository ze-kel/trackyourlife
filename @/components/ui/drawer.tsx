...
export const DrawerMobileTitleContext = React.createContext("");

const DrawerMobileTitleProvider = ({
  title,
  children,
}: {
  title: string;
  ...
  return (
    <DrawerMobileTitleContext.Provider value={title}>
      {children}
    </DrawerMobileTitleContext.Provider>
  );
};
